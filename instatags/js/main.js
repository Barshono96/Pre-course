$(function () {
  ...
  window.Instagram.getUserRecentMedia(USER_ID, function (media) {
    ...
    const filteredTags = filterTags(sortedTags, 2);
  ...
  function sortTagsByFrequencyDesc (tags) {
    ...
    const sortedfrequency = copyTags.sort((a, b) => b.frequency - a.frequency);
  ...
  function handleClickTag (event) {
    ...
    // console.log(tagId);
    var filteredMedia = userMedia.filter(function(el) {
...
function filterTags(tags, minFrequency) {
